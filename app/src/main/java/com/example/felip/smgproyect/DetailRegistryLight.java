...
public class DetailRegistryLight extends AppCompatActivity {

    @BindView(R.id.rv_ListIndicatorLight)
    RecyclerView indicatorsRecyclerView;

    @BindView(R.id.pbr_DetailBarLight)
    ProgressBar progressBar;

    @BindView(R.id.lbl_DetailIndicatorLight)
    TextView labelProgress;

    @BindView(R.id.lbl_NumberIndicatorLight)
    TextView number;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_registry_light);
        ...
        Button btnBackIndicator = (Button) findViewById(R.id.btn_BackDetailIndicatorLight);

        btnBackIndicator.setOnClickListener(v -> {
            Intent i = new Intent(DetailRegistryLight.this, IndicatorsMenu.class);
            startActivity(i);
        });
    ...
    private void getLightDetails(SensorsServiceApi service) {
        Call<List<ConditionsResponse>> call = service.getConditions("light");
