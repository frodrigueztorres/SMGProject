...
public class DetailRegistryHR extends AppCompatActivity {
    ...
    @BindView(R.id.rv_ListIndicatorHr)
    RecyclerView indicatorsRecyclerView;

    private ConditionAdapter conditionAdapter;
    private ArrayList<ConditionsResponse> conditionsList;

    @BindView(R.id.pbr_DetailBarHr)
    ProgressBar progressBar;

    @BindView(R.id.lbl_DetailIndicatorHr)
    TextView labelProgress;

    @BindView(R.id.lbl_NumberIndicatorHR)
    TextView number;
    ...
    private void getHistoric(SensorsServiceApi service) {
        Call<List<ConditionsResponse>> call = service.getConditions("ambient-humidity");
